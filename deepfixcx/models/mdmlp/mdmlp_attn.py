"""
Code from
https://github.com/Amoza-Theodore/MDMLP/blob/51110bd1239155d9dea4574881d3d8c5e6666052/timm/models/mdmlp_ssd/mdmlp_attn.py
Gathered on 2022-11-23
"""
import torch
...
class MDMLP(nn.Module):
    def __init__(self,
        ...
        self.stem = nn.Sequential(OrderedDict([
            ("MDAttnTool", MDAttnTool(img_size=img_size)),
...
@register_model
def mdmlp_attn_32(pretrained=False, **kwargs):
    model_args = dict(img_size=32, base_dim=64, depth=8, patch_size=4, overlap=2, **kwargs)
    return _create_mdmlp('mdmlp_attn_32', pretrained=pretrained, **model_args)
