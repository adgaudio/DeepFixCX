from waveletfix.models.waveletmlp import WaveletFixImg2Img
from matplotlib import pyplot as plt


dfx = WaveletFixImg2Img(1, 2, 19, wavelet='db1', patch_features='l1', restore_orig_size=True)
...
dfc = WaveletFixImg2Img(3, J=7, P=22, wavelet='db1', patch_features='l1', restore_orig_size=True)
...
dfg = WaveletFixImg2Img(3, J=1, P=59, wavelet='db1', patch_features='l1', restore_orig_size=True)
