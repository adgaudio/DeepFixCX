from deepfix.models.waveletmlp import DeepFixImg2Img
from matplotlib import pyplot as plt


dfx = DeepFixImg2Img(1, 2, 19, wavelet='db1', patch_features='l1', restore_orig_size=True)
...
dfc = DeepFixImg2Img(3, J=7, P=22, wavelet='db1', patch_features='l1', restore_orig_size=True)
...
dfg = DeepFixImg2Img(3, J=1, P=59, wavelet='db1', patch_features='l1', restore_orig_size=True)
