...
classes using the VecAttn layer from DeepFixCX.

Assume data of form:
    results/2.C17.Cardiomegaly/checkpoints/epoch_80.pth
    results/2.C17.Pneumonia/checkpoints/epoch_80.pth
    ...
Where each checkpoint contains a DeepFixCXEnd2End model.
"""
...
import re
import torch as T
from deepfixcx.models.waveletmlp import VecAttn, DeepFixCXEnd2End
...
def get_activations(mdl: DeepFixCXEnd2End, pathology):
    """
    Args:
        mdl:  A DeepFixCXEnd2End model with spatial attn layer, trained only on 1 class.
